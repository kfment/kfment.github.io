(function() {
    var II0I0 = function() {
        function t(t) {
            ...
            s = this.table.length,
            e = i = 0,
            l = s - 1; 0 <= l ? i <= l : i >= l; e = 0 <= l ? ++i : --i)
                this.table.push(this.table[e]);
            this.seed < 1 && (this.seed *= 1 << 30),
            this.size = 1024,
            this.normalize = 1 / 1023,
            this.l10Ol = 1023,
            this.IOI0O = this.seed & this.l10Ol,
            this.l1O0I = this.seed >> 10 & this.l10Ol,
            this.OOO00 = this.seed >> 20 & this.l10Ol,
            this.c2d = [],
            this.I0III = Math.cos(.3),
            this.O1l1I = Math.sin(.3)
        }
        ...
        t.prototype.noise1d = function(t) {
            var e, i, s, l;
            return l = Math.floor(t),
            e = t - l,
            l &= this.l10Ol,
            i = this.table[this.IOI0O + this.table[l]],
            s = this.table[this.IOI0O + this.table[l + 1]],
            this.I1O1O(i, s, e) * this.normalize
        }
        ,
        t.prototype.OIOIl = function(t, e) {
            ...
            r &= this.l10Ol,
            h &= this.l10Ol,
            l = this.table[this.IOI0O + this.table[r + this.table[h + this.l1O0I]]],
            n = this.table[this.IOI0O + this.table[r + 1 + this.table[h + this.l1O0I]]],
            a = this.table[this.IOI0O + this.table[r + this.table[h + 1 + this.l1O0I]]],
            o = this.table[this.IOI0O + this.table[r + 1 + this.table[h + 1 + this.l1O0I]]],
            this.I1O1O(this.I1O1O(l, n, i), this.I1O1O(a, o, i), s) * this.normalize
        }
        ,
        t.prototype.OIl1I = function(t, e, i) {
            var s, l, n, a, o, r, h, u, d, c, I, p, O, m, f, g;
            return m = Math.floor(t),
            f = Math.floor(e),
            g = Math.floor(i),
            s = t - m,
            l = e - f,
            ...
            f &= this.l10Ol,
            g &= this.l10Ol,
            a = this.table[this.IOI0O + this.table[m + this.table[f + this.table[this.l1O0I + this.table[g + this.OOO00]]]]],
            o = this.table[this.IOI0O + this.table[m + 1 + this.table[f + this.table[this.l1O0I + this.table[g + this.OOO00]]]]],
            r = this.table[this.IOI0O + this.table[m + this.table[f + 1 + this.table[this.l1O0I + this.table[g + this.OOO00]]]]],
            h = this.table[this.IOI0O + this.table[m + 1 + this.table[f + 1 + this.table[this.l1O0I + this.table[g + this.OOO00]]]]],
            u = this.table[this.IOI0O + this.table[m + this.table[f + this.table[this.l1O0I + this.table[g + 1 + this.OOO00]]]]],
            d = this.table[this.IOI0O + this.table[m + 1 + this.table[f + this.table[this.l1O0I + this.table[g + 1 + this.OOO00]]]]],
            c = this.table[this.IOI0O + this.table[m + this.table[f + 1 + this.table[this.l1O0I + this.table[g + 1 + this.OOO00]]]]],
            I = this.table[this.IOI0O + this.table[m + 1 + this.table[f + 1 + this.table[this.l1O0I + this.table[g + 1 + this.OOO00]]]]],
            p = this.I1O1O(this.I1O1O(a, o, s), this.I1O1O(r, h, s), l),
            O = this.I1O1O(this.I1O1O(u, d, s), this.I1O1O(c, I, s), l),
            this.I1O1O(p, O, n) * this.normalize
        }
        ,
        t.prototype.lOII0 = function(t, e, i) {
            ...
            c = this.table[this.IOI0O + this.table[m + this.table[f + 1 + this.table[this.l1O0I + this.table[g + 1 + this.OOO00]]]]],
            I = this.table[this.IOI0O + this.table[m + 1 + this.table[f + 1 + this.table[this.l1O0I + this.table[g + 1 + this.OOO00]]]]],
            p = this.IO11O(this.IO11O(a, o, s), this.IO11O(r, h, s), l),
            O = this.IO11O(this.IO11O(u, d, s), this.IO11O(c, I, s), l),
            this.IO11O(p, O, n) * this.normalize
        }
        ,
        t.prototype.II0l0 = function(t, e, i) {}
        ,
        ...
        t.prototype.periodicBasic1d = function(t, e, i, s, l) {
            ...
            a = Math.floor(t / e),
            n = t / e - a,
            o = this.basic1d(n * e, i, s, l),
            r = this.basic1d(n * e + e, i, s, l),
            this.I1O1O(o, r, 1 - n)
        }
        ,
        t.prototype.lII1l = function(t, e, i, s, l, n, a, o) {
            ...
            r = t / i - u,
            h = e / i - d,
            c = this.IOOl1(r * i, h * i, s, l, n, a, o),
            I = this.IOOl1(r * i + i, h * i, s, l, n, a, o),
            p = this.IOOl1(r * i, h * i + i, s, l, n, a, o),
            O = this.IOOl1(r * i + i, h * i + i, s, l, n, a, o),
            this.I1O1O(this.I1O1O(c, I, 1 - r), this.I1O1O(p, O, 1 - r), 1 - h)
        }
        ,
        t.prototype.turbulence2d = function(t, e, i, s, l, n, a) {
            ...
            r = 1,
            c = i; r <= c; r += 1)
                I += 2 * (.5 - Math.abs(.5 - this.OIOIl(t, e))) * o,
                h += o,
                o *= s,
                u = l * (t * n + e * a),
                d = l * (e * n - t * a),
        ...
        t.prototype.turbulence3d = function(t, e, i, s, l, n, a, o) {
            ...
            h = 1,
            p = s; h <= p; h += 1)
                O += 2 * (.5 - Math.abs(.5 - this.OIOIl(t, e, i))) * r,
                u += r,
                r *= l,
                d = n * (t * a + e * o),
                c = n * (e * a - t * o),
        ...
        t.prototype.periodicTurbulence2d = function(t, e, i, s, l, n, a, o) {
            ...
            r = t / i - u,
            h = e / i - d,
            c = this.turbulence2d(r * i, h * i, s, l, n, a, o),
            I = this.turbulence2d(r * i + i, h * i, s, l, n, a, o),
            p = this.turbulence2d(r * i, h * i + i, s, l, n, a, o),
            O = this.turbulence2d(r * i + i, h * i + i, s, l, n, a, o),
            this.I1O1O(this.I1O1O(c, I, 1 - r), this.I1O1O(p, O, 1 - r), 1 - h)
        }
        ,
        ...
        t.prototype.O0llI = function(t, e, i) {
            ...
            v = w = 0; w <= 2; v = w += 1)
                for (b = x = 0; x <= 2; b = x += 1)
                    M = (z - 1 + v) % i,
                    S = (E - 1 + b) % i,
                    k = -1 + v + this.table[this.IOI0O + this.table[M + this.table[this.l1O0I + S]]] * this.normalize * .8 + .1,
                    _ = -1 + b + this.table[this.IOI0O + this.table[M + this.table[this.l1O0I + this.table[S + 1]]]] * this.normalize * .8 + .1,
                    p = s - k,
                    f = l - _,
                    d = p * p + f * f,
                    d < n ? (r = n,
        ...
        t.prototype.O00II = function(t, e, i) {
            ...
            u = c = 0; c <= 2; u = c += 1)
                for (d = I = 0; I <= 2; d = I += 1)
                    g = (f - 1 + u) % i,
                    v = (y - 1 + d) % i,
                    p = -1 + u + this.table[this.IOI0O + this.table[g + this.table[this.l1O0I + v]]] * this.normalize * .8 + .1,
                    O = -1 + d + this.table[this.IOI0O + this.table[g + this.table[this.l1O0I + this.table[v + 1]]]] * this.normalize * .8 + .1,
                    m = this.table[this.IOI0O + this.table[g + this.table[this.l1O0I + this.table[v + 17]]]],
                    r = s - p,
                    h = l - O,
                    (o = r * r + h * h) < n && (n = o,
                    p,
        ...
        t.prototype.IIIOI = function(t, e, i, s) {
            ...
            M = T = 0; T <= 2; M = T += 1)
                for (E = P = 0; P <= 2; E = P += 1) {
                    for (S = R = 0; R <= 2; S = R += 1)
                        B = (H - 1 + M) % s & this.l10Ol,
                        L = (D - 1 + E) % s & this.l10Ol,
                        V = (F - 1 + S) % s & this.l10Ol,
                        C = -1 + M + this.table[this.IOI0O + this.table[B + this.table[this.l1O0I + this.table[V + L]]]] * this.normalize,
                        A = -1 + E + this.table[this.IOI0O + this.table[B + this.table[this.l1O0I + this.table[this.table[L + V] + 1]]]] * this.normalize,
                        j = -1 + S + this.table[this.IOI0O + this.table[B + this.table[this.l1O0I + this.table[this.table[L + V] + 37]]]] * this.normalize;
                    g = l - C,
                    b = n - A,
                    k = a - j,
                    O = g * g + b * b + k * k,
            ...
            w = n - h,
            _ = a - u,
            m = Math.sqrt(y * y + w * w + _ * _),
            v = l - c,
            x = n - I,
            z = a - p,
            f = Math.sqrt(v * v + x * x + z * z),
            Math.min(m, f) / Math.max(m, f)
        }
        ,
        t.OllIO = function(t) {
            var e, i, s, l, n, a;
            for (n = [],
            e = s = 0,
            l = t - 1; 0 <= l ? s <= l : s >= l; e = 0 <= l ? ++s : --s)
                n[e] = e;
            for (a = []; ; ) {
                if (0 === n.length)
                    break;
                i = Math.floor(Math.random() * n.length),
                a.push(n.splice(i, 1)[0])
            }
            return a
        }
        ,
      ...
      , lO1ll = function() {
        function t(t) {
            this.seed = null != t ? t : Math.random(),
            this.seed < 1 && (this.seed *= 1 << 30),
            this.a = 13971,
            this.b = 12345,
            this.size = 1 << 30,
            this.l10Ol = this.size - 1,
            this.O0IO0 = 1 / this.size,
            this.lOl10(),
            this.lOl10(),
            this.lOl10()
        }
      ...
      , llOO1 = function() {
        function t(t, e, i) {
            var s, l, n, a, o, r;
            for (this.seed = null != t ? t : Math.random(),
            this.size = null != e ? e : 20,
            this.mode = i,
            this.random = new lO1ll(this.seed),
            this.I1l01 = 1e5 * this.random.next(),
            this.I01IO = 1e5 * this.random.next(),
            this.a = 13971,
            this.c = 12345,
            this.mod = 1 << 30,
            this.inv = 1 / this.mod,
            this.l10Ol = this.mod - 1,
            this.IlO1O = .5,
            this.OlO0O = .5,
            this.lO0l1 = 5,
            this.O1lIO = 1 + this.random.OOOl1(8),
            this.fx = this.O1lIO / this.size,
            this.fy = this.O1lIO / this.size,
            this.fx = (2 + 8 * this.random.next()) / (2 * this.size),
            this.fy = (2 + 8 * this.random.next()) / (2 * this.size),
            this.I000l = new II0I0(this.random.next()),
            this.Ol0I0 = 2 * this.size,
            this.buffer = [],
            this.custom_map = null,
            s = n = 0,
            o = this.Ol0I0 - 1; n <= o; s = n += 1)
                for (l = a = 0,
                r = this.Ol0I0 - 1; a <= r; l = a += 1)
                    this.buffer[s + l * this.Ol0I0] = this.get(s - .5 * this.Ol0I0, l - .5 * this.Ol0I0)
        }
        return t.prototype.O10OI = function(t, e) {
            return t = (t + 3 * this.Ol0I0 / 2) % this.Ol0I0,
            e = (e + 3 * this.Ol0I0 / 2) % this.Ol0I0,
            this.buffer[t + this.Ol0I0 * e]
        }
        ,
        t.prototype.getCustomMap = function(t, e) {
            var i, s, l, n;
            return e = -e - 1,
            null == this.custom_map && (this.custom_map = [],
            null != this.mode.options.custom_map && "string" == typeof this.mode.options.custom_map && (this.custom_map = this.mode.options.custom_map.split("\n"))),
            i = this.custom_map.length,
            i > 0 && (l = Math.floor(-i / 2),
            e >= l && e < l + i && (s = this.custom_map[e - l],
            i = s.length,
            l = Math.floor(-i / 2),
            t >= l && t < l + i && (n = s.charCodeAt(t - l) - 48) >= 0 && n <= 9)) ? n / 9 : 0
        }
        ,
        t.prototype.get = function(t, e, i) {
            ...
            i.bx = t,
            i.by = e,
            o = t * this.I1l01 + e * this.I01IO,
            o = this.a * o + this.c & this.l10Ol,
            o = this.a * o + this.c & this.l10Ol,
            o = this.a * o + this.c & this.l10Ol,
            a = Math.sqrt((t * t + e * e) / (this.size * this.size)),
            r = 1,
            s = a > 1 ? .5 : .5 * Math.pow(a, this.lO0l1),
            s = s * this.OlO0O + (1 - this.OlO0O) * (this.I000l.lII1l((t + this.size) * this.fx, (e + this.size) * this.fy, this.O1lIO, 3) - .5),
            s = Math.max(4 / this.Ol0I0, s),
            null != this.mode && (s *= this.mode.asteroidsDensityModifier(2 * t / this.Ol0I0, 2 * e / this.Ol0I0),
            null != this.mode.options.custom_map) ? (i.size = .5 * this.getCustomMap(t, e),
            i.on = i.size > 0,
            o = this.a * o + this.c & this.l10Ol,
            l = o * this.inv,
            o = this.a * o + this.c & this.l10Ol,
            n = o * this.inv,
            l = l > .5 ? .5 * Math.pow(2 * (l - .5), .1) + .5 : .5 - .5 * Math.pow(2 * (.5 - l), .1),
            n = n > .5 ? .5 * Math.pow(2 * (n - .5), .1) + .5 : .5 - .5 * Math.pow(2 * (.5 - n), .1),
            i.x = t + i.size + l * (1 - 2 * i.size),
            i.y = e + i.size + n * (1 - 2 * i.size),
            i) : (o = this.a * o + this.c & this.l10Ol,
            o * this.inv < s ? (i.on = !0,
            o = this.a * o + this.c & this.l10Ol,
            i.size = (.1 + this.IlO1O * o * this.inv) * r,
            o = this.a * o + this.c & this.l10Ol,
            l = o * this.inv,
            o = this.a * o + this.c & this.l10Ol,
            n = o * this.inv,
            ...
            n = n > .5 ? .5 * Math.pow(2 * (n - .5), .1) + .5 : .5 - .5 * Math.pow(2 * (.5 - n), .1),
            i.x = t + i.size + l * (1 - 2 * i.size),
            i.y = e + i.size + n * (1 - 2 * i.size)) : i.on = !1,
            i)
        }
        ,
        t
      ...
      , installed_modes = [{
        ...
        asteroidsDensityModifier: function(t, e) {
            ...
            s = .5 * Math.sqrt(2),
            null != this.options.teams && 1 === this.options.teams.length && (s = 0),
            i = Math.abs(i - s),
            i < .15 ? 0 : 1
        }
    }]
      , createMapByID = function(mapID, mapSize, gameMode) {
        var size = mapSize
          , edge = size / 2
          , t = new llOO1(mapID,edge,installed_modes[gameMode])
          , map = [...new Array(size)].map(i=>new Array(size).fill(0))
          , f = {};
        for (let i = -edge; i < edge; i++) {
            for (let j = -edge; j < edge; j++) {
                t.get(i, j, f);
                if (f.on)
                    map[Math.trunc(edge - f.y - 0.1)][Math.trunc(f.x + edge)] = Math.max(Math.min(Math.round(f.size * 100 / 6), 9), 1);
            }
        }
        return map;
    }
