!function(e, t) {
    ...
    function _() {}
    function q(e, t) {
        e = Object.create ? Object.create(e) : (_.prototype = e,
        new _);
        return t && P(t, e),
        e
    }
    ...
    function Ln(e, t) {
        ...
        o && !o.text ? o = null : o && o.changes && (ln(e, o, i, _n(e)),
    ...
    function Jn(e, t, n, r) {
        ...
        s = tt(s.line, Math.max(0, Math.round((o - vn(e.display).left) / $n(e.display)) - l))),
        s
    }
    function er(e, t) {
    ...
    function sr(e, t) {
        ...
        for (var s, a, u, c = 0; c < n.sel.ranges.length; c++)
            !t && c == n.sel.primIndex || ((s = n.sel.ranges[c]).from().line >= e.display.viewTo || s.to().line < e.display.viewFrom || (a = s.empty(),
            l ? (u = l(e, s)) && ar(e, u, i) : (a || e.options.showCursorWhenSelecting) && ar(e, s.head, i),
            a || function(i, e, t) {
                var n = i.display
                  , o = i.doc
    ...
    function ar(e, t, n) {
        ...
        /\bcm-fat-cursor\b/.test(e.getWrapperElement().className) && (t = (t = In(e, t, "div", null, null)).right - t.left,
    ...
    e.prototype.update = function(e) {
        ...
        this.vert.firstChild.style.height = Math.max(0, e.scrollHeight - e.clientHeight + t) + "px") : (this.vert.scrollTop = 0,
    ...
    function $i(e, t) {
        if (0 != t && (e.first += t,
        e.sel = new ii($(e.sel.ranges, function(e) {
