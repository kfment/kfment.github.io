!function(e) {
    ...
    T.defineMode("css", function(e, t) {
        ...
        var a, o, i = e.indentUnit, n = t.tokenHooks, l = t.documentTypes || {}, s = t.mediaTypes || {}, d = t.mediaFeatures || {}, c = t.mediaValueKeywords || {}, p = t.propertyKeywords || {}, u = t.nonStandardPropertyKeywords || {}, m = t.fontProperties || {}, g = t.counterDescriptors || {}, b = t.colorKeywords || {}, h = t.valueKeywords || {}, f = t.allowNested, k = t.lineComment, y = !0 === t.supportsAtComponent, w = !1 !== e.highlightNonStandardPropertyKeywords;
        function v(e, t) {
            return a = t,
            e
        }
        ...
        function B(e) {
            ...
            o = h.hasOwnProperty(e) ? "atom" : b.hasOwnProperty(e) ? "keyword" : "variable"
        }
        var _ = {
            top: function(e, t, r) {
                if ("{" == e)
            ...
            atBlock: function(e, t, r) {
                ...
                o = "only" == t || "not" == t || "and" == t || "or" == t ? "keyword" : s.hasOwnProperty(t) ? "attribute" : d.hasOwnProperty(t) ? "property" : c.hasOwnProperty(t) ? "keyword" : p.hasOwnProperty(t) ? "property" : u.hasOwnProperty(t) ? w ? "string-2" : "property" : h.hasOwnProperty(t) ? "atom" : b.hasOwnProperty(t) ? "keyword" : "error"),
                r.context.type)
            },
            ...
            restricted_atBlock: function(e, t, r) {
                ...
                K(r)) : "word" == e ? (o = "@font-face" == r.stateArg && !m.hasOwnProperty(t.current().toLowerCase()) || "@counter-style" == r.stateArg && !g.hasOwnProperty(t.current().toLowerCase()) ? "error" : "property",
    ...
    var t = ["domain", "regexp", "url", "url-prefix"]
      ...
      , k = e(f)
      , f = t.concat(o).concat(a).concat(l).concat(d).concat(p).concat(b).concat(f);
    function y(e, t) {
        for (var r, o = !1; null != (r = e.next()); ) {
            if (o && "/" == r) {
                t.tokenize = null;
